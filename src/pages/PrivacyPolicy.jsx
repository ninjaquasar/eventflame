...
const PrivacyPolicy = () => {
	return (
		<section className="px-6 sm:px-16 lg:px-24 2xl:px-28 mt-4 mb-16">
			<Helmet>
				<title>Privacy Policy - EventFlame</title>
			</Helmet>
			<h2 className="text-4xl font-bold mb-2">Privacy Policy</h2>
			<p className="mb-5">Last updated: May 07, 2025</p>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Collecting and Using Your Personal Data</h3>
			<h4 className="text-2xl font-bold mb-2">Types of Data Collected</h4>
			<h5 className="text-xl font-bold mb-2">Personal Data</h5>
			<p className="mb-4">
			...
			<h5 className="text-xl font-bold mb-2">Usage Data</h5>
			<p className="mb-5">
			...
			<h5 className="text-xl font-bold mb-3">Tracking Technologies and Cookies</h5>
			<p className="mb-4">
			...
			<ul className="list-disc pl-4 space-y-5 mb-5">
			...
			<h4 className="text-2xl font-bold mb-2">Use of Your Personal Data</h4>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-3">Retention of Your Personal Data</h4>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-2">Transfer of Your Personal Data</h4>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-2">Delete Your Personal Data</h4>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-3">Disclosure of Your Personal Data</h4>
			<h5 className="text-xl font-bold mb-2">Business Transactions</h5>
			<p className="mb-5">
			...
			<h5 className="text-xl font-bold mb-2">Law enforcement</h5>
			<p className="mb-5">
				Under certain circumstances, the Company may be required to disclose Your
				Personal Data if required to do so by law or in response to valid requests by
				public authorities (e.g. a court or a government agency).
			</p>
			<h5 className="text-xl font-bold mb-2">Other legal requirements</h5>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-2">Security of Your Personal Data</h4>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-2">Children's Privacy</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-2">Links to Other Websites</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-2">Changes to this Privacy Policy</h3>
			<p className="mb-5">
