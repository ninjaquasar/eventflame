...
const TermsAndConditions = () => {
	return (
		<section className="px-6 sm:px-16 lg:px-24 2xl:px-28 mt-4 mb-16">
			<Helmet>
				<title>Terms and Conditions - EventFlame</title>
			</Helmet>
			<h2 className="text-4xl font-bold mb-2">Terms and Conditions</h2>
			<p className="mb-5">Last updated: May 08, 2025</p>
			<p className="mb-5">
				Please read these terms and conditions carefully before using Our Service.
			</p>
			<h3 className="text-3xl font-bold mb-3">Interpretation and Definitions</h3>
			<h4 className="text-2xl font-bold mb-3">Interpretation</h4>
			<p className="mb-5">
				The words of which the initial letter is capitalized have meanings defined under
				the following conditions. The following definitions shall have the same meaning
				regardless of whether they appear in singular or in plural.
			</p>
			<h4 className="text-2xl font-bold mb-3">Definitions</h4>
			<p className="mb-5">For the purposes of these Terms and Conditions:</p>
			<ul className="list-disc pl-4 space-y-4 mb-5">
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to EventFlame, accessible from{" "}
						<a
							href="https://eventflame.netlify.app"
							rel="external nofollow noopener"
							target="_blank"
						>
							https://eventflame.netlify.app
						</a>
					</p>
				</li>
				<li>
			...
			<h3 className="text-3xl font-bold mb-3">Acknowledgment</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Links to Other Websites</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Termination</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Limitation of Liability</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Governing Law</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Disputes Resolution</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">For European Union (EU) Users</h3>
			<p className="mb-5">
				If You are a European Union consumer, you will benefit from any mandatory
				provisions of the law of the country in which You are resident.
			</p>
			<h3 className="text-3xl font-bold mb-3">United States Legal Compliance</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Severability and Waiver</h3>
			<h4 className="text-2xl font-bold mb-3">Severability</h4>
			<p className="mb-5">
			...
			<h4 className="text-2xl font-bold mb-3">Waiver</h4>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Translation Interpretation</h3>
			<p className="mb-5">
			...
			<h3 className="text-3xl font-bold mb-3">Changes to These Terms and Conditions</h3>
			<p className="mb-5">
